	...
	class SPWPS_Metabox extends SPWPS_Abstract {
		...
		public function add_meta_box_content( $post, $callback ) {
			...
			if ( $the_current_post_type == 'sp_wps_shortcodes' ) {
				...
				echo '<div class="sp-wpsp-mbf-logo"><img src="' . SP_WPS_URL . 'admin/assets/images/wps-logo.png" alt="Product Slider for WooCommerce"></div>';
				echo '<div class="sp-wpsp-mbf-short-links"><a href="https://shapedplugin.com/support-forum/" target="_blank"><i class="fa fa-life-ring"></i> Support</a></div>';
				echo '</div>'; ?>
		...
		<div class="wpspro-col-lg-3">
		  <div class="wpspro_shortcode_content">
		  <h2 class="wpspro-shortcode-title"><?php _e( 'Post or Page editor', 'woo-product-slider' ); ?> </h2>

		  <p><?php _e( 'Insert it into an existing post or page with the icon:', 'woo-product-slider' ); ?></p>
		  <img class="tmce-editor-btn" src="<?php echo SP_WPS_URL . '/admin/assets/images/wps-editor-button.png'; ?>" alt="">
		  </div>
		</div>
		</div>
